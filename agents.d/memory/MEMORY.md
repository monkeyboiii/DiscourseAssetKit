...
- [The EmojiText perf plan is gone](emojitext-perf-plan-lost.md) — two source files cite `DAK_EMOJITEXT_PERF_PLAN.md (umbrella root)`; it lived in no repo; the decisions survive in `enhancement-plan.md` §1/§1b and commit `e7f7b30`
