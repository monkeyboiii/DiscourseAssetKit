...
`agents.d/modules/enhancement-plan.md` §1 (image cache, shipped) and §1b (size-aware resize
...
`agents.d/modules/enhancement-plan.md § 1b` — or let `/module-doc retier` (harness Phase 1) do it.
